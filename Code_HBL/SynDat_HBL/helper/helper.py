...
def load_dataset(dataset_name, n_c, dims, samp_size, basedir, batch_size, kwargs):
    ...
    elif dataset_name == 'syndatzn':
        return load_syndat_zn(basedir, n_c, dims, samp_size, batch_size, kwargs)  
    else:
...
def load_syndat(basedir, n_c, dims, samp_size, batch_size, kwargs):
    ...
    trainloader = torch.utils.data.DataLoader(dat_train, batch_size = batch_size, shuffle = False, **kwargs)
    testloader = torch.utils.data.DataLoader(dat_test, batch_size = batch_size, shuffle = False, **kwargs)

    return trainloader, testloader

# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
def load_syndat_zn(basedir, n_c, dims, samp_size, batch_size, kwargs):
    # Correct basedir.
    basedir += "syndat_zn/"
