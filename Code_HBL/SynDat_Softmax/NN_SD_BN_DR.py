...
def parse_args():
    ...
    parser.add_argument('-drop1', dest="drop1", default=3, type=int)
...
if __name__ == "__main__":
    ...
    wandb.init(project= f'softmax_nc{args.n_c}', entity="damajo", name = f'{int(time.time())}_nc{args.n_c}_bs{args.bs}')
    ...
    def train(net, model, ep, lr):
        ...
        with open(name, "a") as f:
            for epoch in range(EPOCHS):
                ...
                # Learning rate decay.
                if epoch in [args.drop, args.drop1]:
                    learning_rate *= 0.1
...
# python NN_SD_BN_DR.py -c 10 -d 300 -sd 3 -ss 1000 -t 0.2 -s 300 -di syn_data -e 5 -lr 1e-3 -bs 100 -drop 3 -drop1 4 -dr 0.2
